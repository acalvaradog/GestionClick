using EnvioCorreoEventos.Services;
...
class Program
{
    ...
    public static async Task Run()
    {
        Log.Logger = new LoggerConfiguration()
            .WriteTo.File("logs/EnvioEncuestasEventos.txt", rollingInterval: RollingInterval.Year)
            .CreateLogger();
        ...
        var github = services.GetRequiredService<EnvioCorreoServices>();

        var response = await github.EnviarCorreos();
    ...
    public static void Configure(IServiceCollection services)
    {
        ...
        .AddTypedClient<EnvioCorreoServices>();
