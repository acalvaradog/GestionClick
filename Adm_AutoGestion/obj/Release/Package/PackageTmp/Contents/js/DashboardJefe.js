$(document).ready(function () {
    ...
    $('#EvaDesempPendientesP').css('cursor', 'pointer');
    $('#EvaDesempPendientesE').css('cursor', 'pointer');
    $('#HEPendientes').css('cursor', 'pointer');

    $('#Vacaciones').click(function ()
    { window.location.href = '../Vacaciones/AprobacionSuperior?All=SI'; });
    $('#Incapacidades').click(function ()
    { window.location.href = '../Incapacidades/InformeJefe'; });
