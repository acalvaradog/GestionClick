...
{
    public class DetallePersonalSalud
    {
        ...
        public string IdPerfilProfesional{ get; set; }
        [ForeignKey("IdPerfilProfesional")]
        public THSPerfil THSPerfil { get; set; }
        [Required]
        [StringLength(200)]
        ...
        [ForeignKey("IdCargo")]
        public CargoAsistencial CargoAsistencial { get; set; }
        ...
        [NotMapped]
        public virtual List<CargoAsistencial> ListadoCargoAsistencial { get; set; }
        [NotMapped]
